...
const homePage = () => html`
  ...
  <main class="container flex-col md:flex-row" id="main">
    ...
    <footer class="relative h-24">
      <a
        href="https://github.com/Em3c2/emilia-about"
        target="_blank"
        rel="noopener noreferrer"
        class="fixed w-12 h-12 flex lg:w-10 lg:h-10 pl-4 pt-4 lg:p-2 right-0 bottom-0 lg:right-10 lg:bottom-10 bg-stone-300 text-black dark:text-black rounded-tl-full lg:rounded-full overflow-hidden"
      >
