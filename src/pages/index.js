...
const homePage = () => html`
  ...
  <main class="container flex-col md:flex-row" id="main">
    ...
    <a
      ...
      class="fixed w-12 h-12 flex lg:w-10 lg:h-10 pl-4 pt-4 lg:p-2 right-0 bottom-0 lg:right-10 lg:bottom-10 backdrop-blur text-black lg:bg-stone-300 lg:hover:animate-spin rounded-tl-full lg:rounded-full overflow-hidden"
    >
